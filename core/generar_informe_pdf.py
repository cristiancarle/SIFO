...
def _generar_estrategia_periodo(meteo_periodo, topografia, combustible):
    ...
    if humedad is not None:
        if humedad < 25:
            ...
            estrategias.append("Posible aceleración rápida del fuego.")
        elif humedad < 35:
    ...
    if temp is not None and temp > 30:
        ...
        estrategias.append(f"❄️ Temperatura baja ({temp}°C): Propagación reducida.")

    pendiente = topografia.get("maxima_pendiente_pct") or 0
    if pendiente > 20:
        estrategias.append("⛰️ Terreno muy pendiente: El fuego se acelera en sentido ascendente.")
